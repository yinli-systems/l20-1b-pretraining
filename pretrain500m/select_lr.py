#!/usr/bin/env python3
"""Apply the frozen v2 learning-rate selection rule to completed pilots."""
...
EXPECTED_PROTOCOL_SHA256 = "1b44371442a5c418c64f012ec5d9864718448d7bc9f81e56e7e04f34d551b4f3"
EXPECTED_TRAIN_SHA256 = "3d9469d6bd3cc844ee690f37730b08051a8a38c4b2cf2d1d1b6c8377cf9655cc"
...
def main() -> None:
    ...
    for peak_lr in [float(value) for value in rule["candidates"]]:
        directory = args.root / "pilots" / f"lr-long-v2-{args.pilot_job}" / f"lr-{peak_lr}"
