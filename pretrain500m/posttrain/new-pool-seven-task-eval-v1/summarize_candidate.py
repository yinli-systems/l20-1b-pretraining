#!/usr/bin/env python3
"""Validate and summarize one new-pool seven-task capability evaluation."""
...
def main() -> None:
    ...
    if plan.get("schema") != "p529m-new-pool-seven-task-eval-plan-v1":
    ...
    if len(candidates) != 4 or args.candidate_id not in candidates:
    ...
    result = {
        "schema": "p529m-new-pool-seven-task-eval-result-v1",
        "status": "PASS_ADAPTIVE_NEW_POOL_SEVEN_TASK_SCREEN",
        "candidate": candidate,
        "protocol_id": plan["protocol_id"],
        "protocol_sha256": plan["protocol_sha256"],
        "base_aggregate_score": base_score,
        "candidate_aggregate_score": candidate_score,
        "aggregate_delta_vs_base": candidate_score - base_score,
