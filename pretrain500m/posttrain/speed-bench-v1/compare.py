...
def main():
    ...
    a = [runs["A_true_1"]["steady_mfu_median"], runs["A_true_2"]["steady_mfu_median"]]
    b = [runs["B_false_1"]["steady_mfu_median"], runs["B_false_2"]["steady_mfu_median"]]
    a_center = statistics.median(a)
    b_center = statistics.median(b)
    speedup = b_center / a_center
    differences = {
        "A_true_1_vs_B_false_1": max_numeric_difference(runs["A_true_1"], runs["B_false_1"]),
        "A_true_2_vs_B_false_2": max_numeric_difference(runs["A_true_2"], runs["B_false_2"]),
    }
    ...
    result = {
        ...
        "design": "same-allocation ABBA, identical seed/data/base/schedule, 20 steps each",
        "variant_A": "find_unused_parameters=true",
        "variant_B": "find_unused_parameters=false",
        "steady_steps": "6..20",
        "per_run": {label: {
