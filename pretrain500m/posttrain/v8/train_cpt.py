"""CPT v8 throughput runner with the qualified v4 DDP reduction policy."""
import argparse
import contextlib
import hashlib
import json
...
def main():
    ...
    manifest={'status':'qualification_only',
      ...
      'ddp_policy':{'find_unused_parameters':True,'static_graph':False,
    ...
    # This exact policy is qualified by recovery-v2 job 1588249 and the healthy
    # v4 formal screens. Static graph is deliberately excluded: job 1588605
    # reproduced PyTorch issue 143580 on the first no_sync backward pass.
