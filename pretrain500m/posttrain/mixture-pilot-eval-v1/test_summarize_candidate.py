...
def test_summarizes_hash_bound_candidate_against_base(tmp_path):
    ...
    candidate_id = "r3-lr1e4-seed20260916"
    checkpoint_sha = hashlib.sha256(candidate_id.encode()).hexdigest()
    candidates = [
        {"id": candidate_id, "checkpoint_sha256": checkpoint_sha, "expected_step": 256},
        {"id": "r0-lr6e5-seed20260916", "checkpoint_sha256": "b" * 64, "expected_step": 256},
        {"id": "r4-lr6e5-seed20260916", "checkpoint_sha256": "c" * 64, "expected_step": 256},
    ]
    plan = tmp_path / "plan.json"
    write(plan, {
        "schema": "p529m-mixture-pilot-capability-screen-v1",
        "status": "FROZEN_BEFORE_CAPABILITY_SCREEN",
        "protocol_id": "test",
        "protocol_sha256": protocol,
