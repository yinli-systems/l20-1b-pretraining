#!/usr/bin/env python3
"""Validate and summarize one mixture-pilot capability evaluation."""
...
def main() -> None:
    ...
    if plan.get("schema") != "p529m-mixture-pilot-capability-screen-v1":
    ...
    if len(candidates) != 3 or args.candidate_id not in candidates:
    ...
    result = {
        "schema": "p529m-mixture-pilot-capability-result-v1",
        "status": "PASS_ADAPTIVE_SEVEN_TASK_CAPABILITY_SCREEN",
        "candidate": candidate,
