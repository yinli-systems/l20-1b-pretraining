#!/usr/bin/env python3
"""Validate and summarize the N4 new-pool seven-task capability evaluation."""
...
def main() -> None:
    ...
    if plan.get("schema") != "p529m-new-pool-seven-task-eval-plan-v2":
    ...
    if len(candidates) != 1 or args.candidate_id not in candidates:
    ...
    result = {
        "schema": "p529m-new-pool-seven-task-eval-result-v2",
