...
def test_summarizes_hash_bound_candidate_against_base(tmp_path):
    ...
    write(
        plan,
        {
            "schema": "p529m-new-pool-seven-task-eval-plan-v2",
            "status": "FROZEN_N4_BEFORE_EVALUATION",
            "protocol_id": "test",
            "protocol_sha256": protocol,
    ...
    write(
        receipt,
        {
            ...
            "checkpoint_sha256": candidates[0]["checkpoint_sha256"],
            "checkpoint_step": 256,
        },
    )
    ...
    assert result["candidate"]["id"] == "n0-lr6e5"
