"""Revision-pinned, bounded raw intake for the DCLM post-filter top-up plan.
...
OUTPUT = ROOT / "data/intake-dclm-topup-v1"
MIN_FREE = 18 * 1024**3
OUTER_WORKERS = 1
CODE_WORKERS = 64
CACHE = Path("/dev/shm/p529m-intake-dclm-topup-v1")
