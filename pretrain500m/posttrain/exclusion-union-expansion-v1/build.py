#!/usr/bin/env python3
"""Extend a frozen prefix exclusion union with identity-bound appended audits."""
...
def build(prior_path: Path, supplemental_path: Path, legacy_path: Path,
    ...
    return {
        "schema": "p529m-exclusion-union-expansion-v1",
        ...
        "scope": (
            "Conservative union of a frozen historical-prefix exclusion plan and all "
            "identity-bound appended-tranche supplemental, legacy-hash, and old-source candidates."
        ),
    }
