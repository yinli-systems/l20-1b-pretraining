#!/usr/bin/env python3
"""Validate and summarize one R4 extension capability evaluation."""
...
def main() -> None:
    ...
    if plan.get("schema") != "p529m-r4-extension-capability-screen-v1":
    ...
    result = {
        "schema": "p529m-r4-extension-capability-result-v1",
        "status": "PASS_ADAPTIVE_R4_EXTENSION_SEVEN_TASK_SCREEN",
        "candidate": candidate,
