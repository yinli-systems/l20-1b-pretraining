...
def main():
    ...
    manifest={'status':'pilot' if a.pilot_steps else 'formal','from_scratch':True,'initial_checkpoint':None,
      ...
      'deterministic_algorithms':a.deterministic,'ddp_gradient_reduction':'bfloat16_compress_hook',
    ...
    fingerprint_fields={key:manifest[key] for key in (
      ...
      'data_manifest_sha256','protocol_sha256','deterministic_algorithms','ddp_gradient_reduction')}
