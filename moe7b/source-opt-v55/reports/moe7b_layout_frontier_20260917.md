...
The three 8-way candidate layouts are microbatch/accumulation 2/4, 4/2, and 8/1.  Each
...
Source v55 adds a separate 4-way EP screen at microbatch/accumulation 4/4. It
keeps the same 131,072 prediction tokens per optimizer step while placing four
experts on each GPU. This is a scheduler-availability and kernel-granularity
candidate; it must independently meet the same 50% MFU, finite-value, and 2 GiB
headroom gates. A pass authorizes numerical qualification only, not training.
